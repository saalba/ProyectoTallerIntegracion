...
class BalancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create balance" do
    assert_difference('Balance.count') do
      post balances_url, params: { balance: { acount: @balance.acount, amount: @balance.amount } }, as: :json
    end
  ...
  test "should update balance" do
    patch balance_url(@balance), params: { balance: { acount: @balance.acount, amount: @balance.amount } }, as: :json
    assert_response 200
  end
